            ...
            >
                ...
                <motion.div variants={itemVariants} className="text-center mb-12">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto">
                        Serving the people of Tagbilaran City and the Province of Bohol 
                        with integrity and dedication to justice
                    </p>
                </motion.div>
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="flex items-start gap-6 mb-8">
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl 
                                    ...
                                    <i className={`fas ${sections[activeSection].icon} text-white text-2xl md:text-3xl`}></i>
                                </div>
                                <div>
