      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] 
                                bg-gradient-radial from-blue-100/20 to-transparent rounded-full"
        ></div>
      </div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex justify-center mb-12">
          ...
          >
            {/* Glow Effect */}
            <div
              className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-blue-400/20 to-blue-500/20 
            ...
            {/* Logo Container */}
            <div
              className="relative p-8 md:p-12 rounded-full 
        ...
        >
          {[
            ...
            { icon: 'fa-shield-halved', label: 'Secure System', desc: 'Protected data' },
            {
              ...
              desc: 'Access your case details in real-time',
            },
          ].map((item, index) => (
            <motion.div
              key={index}
