  ...
  if (showFullTemplate) {
    return (
      ...
      >
        ...
        {/* O.R No and Date */}
        <div style={{ marginLeft: '0.3in', marginBottom: '12pt', marginTop: '24pt', color: FORMAT_C_CONFIG.textColor }}>
          <p style={{ marginBottom: '4pt' }}>
        ...
        {/* Note */}
        <p style={{ fontSize: '9pt', fontStyle: 'italic', marginTop: '16pt', color: FORMAT_C_CONFIG.textColor }}>
...
export const getFormatCHtml = (formData: FormData, fullName: string, generatedOR?: string | null): string => {
  ...
  const statusHtml = `<p style="text-align: center; font-weight: bold; font-size: 25pt; color: ${FORMAT_C_CONFIG.noRecordColor}; margin: 12pt 0 24pt 0;">"NO CRIMINAL RECORD"</p>`;
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
    body { margin: 0; padding: 0; font-family: ${FORMAT_C_CONFIG.fontFamily}; font-size: 12pt; line-height: 1.0; color: ${FORMAT_C_CONFIG.textColor}; background: white; }
  ...
  <div class="certificate-container">
    ...
    <div class="header">
      ...
      <div class="header-text">
        <p style="font-size: 12pt; font-style: normal; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Republic of the Philippines</p>
        <p style="font-size: 12pt; font-style: normal; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Department of Justice</p>
        <p style="font-size: 12pt; font-weight: bold; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">OFFICE OF THE CITY PROSECUTOR</p>
        <p style="font-size: 12pt; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">City of Tagbilaran</p>
        <p style="font-size: 9pt; font-style: italic; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Hall of Justice Building, Brgy. Cogon,</p>
        <p style="font-size: 9pt; font-style: italic; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Tagbilaran City</p>
        <p style="font-size: 9pt; font-style: italic; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Tel. No. 411-3403/411-2306</p>
        <p style="font-size: 9pt; font-style: italic; color: ${FORMAT_C_CONFIG.textColor}; line-height: 1.0;">Email: <a href="mailto:ocptagbilaran@doj.gov.ph" style="color: ${FORMAT_C_CONFIG.textColor};">ocptagbilaran@doj.gov.ph</a></p>
      </div>
    ...
    <!-- SALUTATION -->
    <p style="font-size: 12pt; font-weight: bold; margin-bottom: 4pt; color: ${FORMAT_C_CONFIG.textColor};">TO WHOM IT MAY CONCERN:</p>
    ...
    <div style="color: #000080;">
      ...
      <p style="text-indent: 0.5in; text-align: justify; margin-bottom: 10pt; font-size: 12pt; line-height: 1.6; margin-top: 0; color: #000080;">
        &nbsp &nbsp &nbsp &nbsp &nbsp THIS IS TO CERTIFY that the records of this office show that one 
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin: 16pt 0.5in;">
        <!-- Left side - Signature -->
        <div style="text-align: center; margin-left: 2.2in;">
          <p style="font-weight: bold; margin-bottom: 8pt; text-transform: uppercase; border-bottom: 1px solid #000080; padding-bottom: 2pt; display: inline-block; font-size: 12pt; color: #000080;">
            ${signatureName || '[NAME]'}
          </p>
      ...
      <!-- Witness Clause -->
      <p style="text-indent: 0.5in; text-align: justify; margin-top: 8pt; margin-bottom: 6pt; font-size: 12pt; line-height: 1.4; color: #000080;">
        WITNESS MY HAND this 
    ...
    <div style="text-align: right; margin-top: 4pt; margin-right: 0.3in; display: flex; flex-direction: column; align-items: flex-end;">
      <p style="font-size: 12pt; font-weight: bold; margin-bottom: 8pt; text-transform: uppercase; color: #000080;">FOR THE CITY PROSECUTOR:</p>
      <div style="height: 20pt;"></div>
      <p style="font-size: 12pt; font-weight: bold; margin-bottom: 0; margin-right: 25pt; color: #000080;">REGIE C. POCON</p>
      <p style="font-size: 12pt; font-style: normal; margin-top: 0pt; margin-right: 5pt; color: #000080;">Administrative  Officer V</p>
    </div>
    <!-- FOOTER -->
    <div style="margin-left: -0.1; margin-top: 0;">
    ...
    <!-- Note -->
    <p style="font-size: 9pt; font-style: italic; margin-top: 2pt; margin-bottom: -3; color: #000080;">
