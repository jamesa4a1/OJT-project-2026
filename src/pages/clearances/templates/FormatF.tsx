 ...
 * 
 * This format is specifically for BALSAFF (Barangay Lupon Tagapamayapa
 * Accreditation for Settlement of Fiscal Filings) applications.
 * Used when the individual has cases that may be eligible for BALSAFF.
 */
...
// ============================================
export const getFormatFPrintTemplate = (props: TemplateProps): string => {
  const { formData, fullName } = props;
  
  // Format F uses similar template to Format B (Has Criminal Record) but for BALSAFF purposes
  return `
    <!-- Format F - Balsaff Application (With Case) -->
    ...
    <!-- Issued upon request section for BALSAFF -->
    ...
    <p style="margin: 0; line-height: 1.0; font-size: 10pt; margin-left: 110pt;">
      <span>Purpose: </span>
      <strong><u>APPLICATION FOR BALSAFF</u></strong>
    </p>
...
// ============================================
// PREVIEW COMPONENT - Format F
// ============================================
export const FormatFPreview: React.FC<PreviewTemplateProps> = ({ formData, fullName, textColor, generatedOR, getOrdinalSuffix }) => {
  return (
    <div>
      <p style={{ 
        marginBottom: '8pt',
      ...
      <div style={{ marginTop: '10pt', marginLeft: '0.3in', fontSize: '9pt', lineHeight: '1.4' }}>
        ...
        <p style={{ marginBottom: '2pt' }}>
          ...
          <span style={{ marginLeft: '8px', textDecoration: 'underline' }}>
            <strong>APPLICATION FOR BALSAFF</strong>
          </span>
        </p>
      </div>
...
export default {
  getPrintTemplate: getFormatFPrintTemplate,
  Preview: FormatFPreview,
};
