    ...
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '12px' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center', fontFamily: FORMAT_A_CONFIG.fontFamily, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', margin: '0 0.15in' }}>
          <p style={{ color: textColor, fontSize: '11pt', fontStyle: 'normal', marginBottom: '1pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>Republic of the Philippines</p>
          <p style={{ color: textColor, fontSize: '11pt', fontStyle: 'normal', marginBottom: '1pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>Department of Justice</p>
          <p style={{ color: textColor, fontSize: '11pt', fontWeight: 'bold', marginBottom: '1pt', lineHeight: '1.0', margin: '0' }}>OFFICE OF THE CITY PROSECUTOR</p>
          <p style={{ color: textColor, fontSize: '11pt', marginBottom: '2pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>City of Tagbilaran</p>
          <p style={{ color: textColor, fontSize: '7pt', fontStyle: 'italic', marginBottom: '1pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>Hall of Justice Building, Brgy. Cogon, Tagbilaran City</p>
          <p style={{ color: textColor, fontSize: '7pt', fontStyle: 'italic', marginBottom: '1pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>Tel. No. 411-3403/411-2306</p>
          <p style={{ color: '#000080', fontSize: '8pt', fontStyle: 'italic', marginBottom: '0pt', lineHeight: '1.0', fontWeight: 'normal', margin: '0' }}>
      ...
      {/* Salutation */}
      <p style={{ fontWeight: 'bold', marginBottom: '8pt', textAlign: 'left', fontSize: '10pt', textTransform: 'uppercase', color: textColor }}>
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
    ...
    .header .right-logo { margin-left: 0.25in; }
  ...
  <div class="certificate-container">
    ...
    <div class="header">
      ...
      <div class="header-text">
        <p style="font-size: 11pt; font-style: normal; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">Republic of the Philippines</p>
        <p style="font-size: 11pt; font-style: normal; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">Department of Justice</p>
        <p style="font-size: 11pt; font-weight: bold; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">OFFICE OF THE CITY PROSECUTOR</p>
        <p style="font-size: 11pt; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">City of Tagbilaran</p>
        <p style="font-size: 8pt; font-style: italic; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">Hall of Justice Building, Brgy. Cogon, Tagbilaran City</p>
        <p style="font-size: 8pt; font-style: italic; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">Tel. No. 411-3403/411-2306</p>
        <p style="font-size: 8pt; font-style: italic; color: ${FORMAT_A_CONFIG.textColor}; line-height: 1.2; ">Email: <a href="mailto:ocptagbilaran@doj.gov.ph" style="color: ${FORMAT_A_CONFIG.textColor};">ocptagbilaran@doj.gov.ph</a></p>
      </div>
